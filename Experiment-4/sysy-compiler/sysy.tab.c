...
{
       0,    65,    65,    73,    78,    83,    89,    95,   100,   110,
...
static const char *const yytname[] =
{
  ...
  "WHILE", "CONTINUE", "BREAK", "ADD", "SUB", "MUL", "DIV", "MOD",
  "ASSIGN", "SEMI", "COMMA", "LPAREN", "RPAREN", "LBRACE", "RBRACE",
  "LBRACKET", "RBRACKET", "INT_CONST", "'!'", "'<'", "'>'", "$accept",
  "CompUnit", "CompUnits", "FuncDefOrVarDecl", "Decl", "ConstDecl",
  "BType", "ConstDef", "Bracket", "ConstInitVal", "Brace", "ConstExp",
  "VarDecl", "VarDecl_", "VarDef", "InitVal", "FuncDef_", "FuncFParams",
  "FuncFParam", "Block", "BlockItem", "Stmt", "Exp", "LVal", "PrimaryExp",
...
{
       0,     4,     6,     7,    39,    40,    41,    43,    44,    44,
       3,    54,     0,     7,    41,    43,     3,    51,    52,    54,
       3,    45,    28,    54,    25,    27,    32,    46,    26,    25,
      32,    26,    29,    44,    55,    56,     3,    20,    21,    28,
      30,    34,    35,    53,    60,    61,    62,    63,    64,    65,
      67,    68,    69,    70,    71,    72,     3,    52,    49,    60,
      25,    27,    30,    47,    49,    46,    49,    30,    57,     3,
      29,    28,    32,    60,    31,    47,    48,    27,    64,    22,
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::unique_ptr<BaseAST> &ast)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, std::unique_ptr<BaseAST> &ast)
{
  YYFPRINTF (yyo, "%s %s (",
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yytype, yyvaluep, yylocationp, ast);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, std::unique_ptr<BaseAST> &ast)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, std::unique_ptr<BaseAST> &ast)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (ast);
...
#line 166 "src/sysy.y"
    ...
    ast->bracket = unique_ptr<BaseAST>((yyvsp[-3].ast_val));
    ast->const_init_val = unique_ptr<BaseAST>((yyvsp[0].ast_val));
    (yyval.ast_val) = ast;
  }
...
#line 173 "src/sysy.y"
    ...
    ast->bracket = unique_ptr<BaseAST>((yyvsp[-5].ast_val));
    ast->const_init_val = unique_ptr<BaseAST>((yyvsp[-2].ast_val));
    ast->const_def = unique_ptr<BaseAST>((yyvsp[0].ast_val));
    (yyval.ast_val) = ast;
  }
...
#line 304 "src/sysy.y"
    ...
    auto ast = new VarDefAST();
    ast->ident = *unique_ptr<string>((yyvsp[-5].str_val));
    ast->bracket = unique_ptr<BaseAST>((yyvsp[-4].ast_val));
    ast->init_val = unique_ptr<BaseAST>((yyvsp[-2].ast_val));
    ast->var_def = unique_ptr<BaseAST>((yyvsp[0].ast_val));
    (yyval.ast_val) = ast;
  }
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, yylsp, ast);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
